...
@Component
class ReviseAccountCommandHandler(
    private val timestampProvider: TimestampProvider,
    private val projectionApplier: ProjectionApplier,
    private val validationService: AccountValidationService,
    eventsDAO: EventsDAO,
) : AbstractAccountCommandHandler<ReviseAccountCommand, AccountProjection, AccountRevised>(
    eventsDAO
) {
    override val commandType: KClass<out ReviseAccountCommand> = ReviseAccountCommand::class

    override fun handle(command: ReviseAccountCommand): AccountProjection {
    ...
    override fun buildEventPayload(command: ReviseAccountCommand): AccountRevised {
